# StreamTR — Resiliency Kılavuzu

> Bu doküman, StreamTR web uygulamasının kararlı, tutarlı ve dayanıklı çalışması için uygulanması gereken resiliency örüntülerini tanımlar.  
> Uygulama tamamen frontend'de çalışır; tüm dış bağımlılık **Anthropic Claude API** üzerinden gider.
