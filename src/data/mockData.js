...
export const MOCK_DIZILER = [
  {
    ...
    genres: ["Dram", "Suç", "Gerilim"], imdbScore: 9.5, rottenTomatoesScore: 98,
  ...
  },
  {
    ...
    genres: ["Tarih", "Dram", "Gerilim"], imdbScore: 9.4, rottenTomatoesScore: 96,
  ...
  {
    title: "Bant of Brothers", originalTitle: "Band of Brothers",
    genres: ["Tarih", "Dram", "Aksiyon"], imdbScore: 9.4, rottenTomatoesScore: 97,
  ...
  },
  {
    ...
    genres: ["Suç", "Dram", "Gerilim"], imdbScore: 9.3, rottenTomatoesScore: 94,
  ...
  },
  {
    ...
    genres: ["Fantezi", "Dram", "Aksiyon"], imdbScore: 9.2, rottenTomatoesScore: 89,
    platforms: ["Amazon Prime"], year: 2011,
  ...
  },
  {
    ...
    genres: ["Suç", "Dram"], imdbScore: 9.2, rottenTomatoesScore: 92,
    platforms: ["Amazon Prime"], year: 1999,
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Korku", "Dram"], imdbScore: 8.7, rottenTomatoesScore: 93,
  ...
  },
  {
    ...
    genres: ["Suç", "Dram", "Tarih"], imdbScore: 8.8, rottenTomatoesScore: 88,
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Gerilim", "Dram"], imdbScore: 8.8, rottenTomatoesScore: 94,
  ...
  },
  {
    ...
    genres: ["Dram", "Aksiyon", "Gerilim"], imdbScore: 8.0, rottenTomatoesScore: 95,
  ...
  },
  {
    ...
    genres: ["Suç", "Gerilim", "Dram"], imdbScore: 8.6, rottenTomatoesScore: 97,
    platforms: ["Netflix"], year: 2017,
  ...
  },
  {
    ...
    genres: ["Suç", "Dram", "Gerilim"], imdbScore: 8.4, rottenTomatoesScore: 82,
    platforms: ["Netflix"], year: 2017,
  ...
  },
  {
    ...
    genres: ["Suç", "Dram", "Tarih"], imdbScore: 8.8, rottenTomatoesScore: 89,
  ...
  },
  {
    ...
    genres: ["Tarih", "Dram"], imdbScore: 8.6, rottenTomatoesScore: 90,
    platforms: ["Netflix"], year: 2016,
  ...
  },
  {
    ...
    genres: ["Suç", "Dram", "Komedi"], imdbScore: 9.0, rottenTomatoesScore: 98,
    platforms: ["Netflix"], year: 2015,
  ...
  },
  {
    ...
    genres: ["Suç", "Gerilim", "Dram"], imdbScore: 8.9, rottenTomatoesScore: 87,
    platforms: ["Amazon Prime"], year: 2014,
  ...
  },
  {
    ...
    genres: ["Tarih", "Aksiyon", "Dram"], imdbScore: 8.1, rottenTomatoesScore: null,
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Gerilim", "Dram"], imdbScore: 8.7, rottenTomatoesScore: 98,
    ...
    reviews: [
      ...
      { source: "Rotten Tomatoes", author: "Eleştirmen", quote: "Distopik kurgunun en yaratıcı ve en sinir bozucu (iyimanada) yapımı." },
    ],
  },
  {
    title: "Succession", originalTitle: "Succession",
    genres: ["Dram", "Komedi"], imdbScore: 8.9, rottenTomatoesScore: 99,
    platforms: ["Amazon Prime"], year: 2018,
  ...
  },
  {
    ...
    genres: ["Dram", "Bilim Kurgu", "Aksiyon"], imdbScore: 8.8, rottenTomatoesScore: 96,
    platforms: ["Amazon Prime"], year: 2023,
  ...
  },
  {
    ...
    genres: ["Romantik", "Dram"], imdbScore: 8.3, rottenTomatoesScore: null,
    platforms: ["Netflix"], year: 2017,
...
export const MOCK_FILMLER = [
  {
    ...
    genres: ["Dram"], imdbScore: 9.3, rottenTomatoesScore: 91,
    ...
    cast: [
      ...
      { name: "Morgan Freeman", character: "Ellis Boyd 'Red' Redding", profilePath: "/jPsLqiYGSofU4jTsI7 Academia0.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Suç", "Dram"], imdbScore: 9.2, rottenTomatoesScore: 98,
    ...
    cast: [
      ...
      { name: "James Caan", character: "Sonny Corleone", profilePath: "/j6P1TY0q2NZPQ3D4pJmcL4Pjk8A.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Aksiyon", "Suç", "Dram"], imdbScore: 9.0, rottenTomatoesScore: 94,
    ...
    cast: [
      ...
      { name: "Aaron Eckhart", character: "Harvey Dent", profilePath: "/kxmEJeOdYovVX0qkxVDM2B3i7KP.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Tarih", "Dram"], imdbScore: 9.0, rottenTomatoesScore: 98,
    ...
    cast: [
      ...
      { name: "Ben Kingsley", character: "Itzhak Stern", profilePath: "/giGBjw0XqHCUPDFevJVpAWoHJbH.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Suç", "Dram"], imdbScore: 8.9, rottenTomatoesScore: 92,
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Aksiyon", "Gerilim"], imdbScore: 8.8, rottenTomatoesScore: 87,
    ...
    cast: [
      ...
      { name: "Elliot Page", character: "Ariadne", profilePath: "/5tZAQu6QEbVmScmqQZ0lrr0GiaK.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Dram", "Aksiyon"], imdbScore: 8.7, rottenTomatoesScore: 73,
    ...
    cast: [
      ...
      { name: "Jessica Chastain", character: "Murph", profilePath: "/9PbhQ2ZBqXMZEjODsKHN28wr9Q8.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Dram", "Gerilim"], imdbScore: 8.8, rottenTomatoesScore: 79,
    ...
    cast: [
      ...
      { name: "Helena Bonham Carter", character: "Marla Singer", profilePath: "/4p60bS2Z1zTHjMRtHHBaKR6FBfn.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Dram", "Romantik", "Komedi"], imdbScore: 8.8, rottenTomatoesScore: 71,
    platforms: ["Netflix", "Amazon Prime"], year: 1994, duration: 142,
    ...
    cast: [
      ...
      { name: "Gary Sinise", character: "Lt. Dan Taylor", profilePath: "/6x2gbT8iGLF8VgKXv07xyAr3qXr.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Aksiyon"], imdbScore: 8.7, rottenTomatoesScore: 88,
    ...
    cast: [
      ...
      { name: "Carrie-Anne Moss", character: "Trinity", profilePath: "/xjdGw0mXf3q7CzBkMWRqBnEUgGC.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Fantezi", "Aksiyon", "Dram"], imdbScore: 8.9, rottenTomatoesScore: 92,
    ...
    cast: [
      ...
      { name: "Viggo Mortensen", character: "Aragorn", profilePath: "/vH5gVSpHAMhDaFWfh0Q7BG61O1K.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Suç", "Dram"], imdbScore: 8.7, rottenTomatoesScore: 97,
    ...
    cast: [
      ...
      { name: "Joe Pesci", character: "Tommy DeVito", profilePath: "/4i5TfGAJfYEXVvXx5rcKy3sDPAn.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Gerilim", "Suç", "Korku"], imdbScore: 8.6, rottenTomatoesScore: 96,
  ...
  },
  {
    ...
    genres: ["Dram", "Gerilim", "Komedi"], imdbScore: 8.5, rottenTomatoesScore: 99,
  ...
  },
  {
    ...
    genres: ["Dram", "Müzik"], imdbScore: 8.5, rottenTomatoesScore: 94,
  ...
  },
  {
    ...
    genres: ["Aksiyon", "Dram", "Tarih"], imdbScore: 8.5, rottenTomatoesScore: 77,
    ...
    reviews: [
      { source: "IMDB", author: "aksiyonmaster", quote: "Are you not entertained?! Tabii ki evet. Russell Crowe kariyerinin zirvesinde." },
  ...
  },
  {
    ...
    genres: ["Dram", "Gerilim", "Bilim Kurgu"], imdbScore: 8.5, rottenTomatoesScore: 76,
    ...
    cast: [
      ...
      { name: "Michael Caine", character: "Cutter", profilePath: "/pEFRzXtLeyPn2mKgvKBn95m1j5R.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Dram", "Suç", "Gerilim"], imdbScore: 8.4, rottenTomatoesScore: 69,
  ...
  },
  {
    ...
    genres: ["Bilim Kurgu", "Aksiyon", "Dram"], imdbScore: 8.0, rottenTomatoesScore: 83,
    ...
    cast: [
      ...
      { name: "Oscar Isaac", character: "Leto Atreides", profilePath: "/dW5U5yrIIPmMjRThR9KT2xH6nTe.jpg" },
    ],
    reviews: [
  ...
  },
  {
    ...
    genres: ["Tarih", "Dram", "Biyografi"], imdbScore: 8.3, rottenTomatoesScore: 93,
...
export const MOCK_TREND = [
  ...
  },
  {
    ...
    platforms: ["Amazon Prime"], year: 2023, socialScore: 96,
  ...
  },
  {
    ...
    trendReason: "Final sezonu 2025'te geliyor, trailer sosyal medyayı yaktı",
  ...
  {
    title: "Joker: Folie à Deux", originalTitle: "Joker: Folie à Deux",
    type: "film", genres: ["Dram", "Müzikal"], imdbScore: 5.2,
    platforms: ["Amazon Prime"], year: 2024, socialScore: 85,
    trendReason: "Tartışmalı devam filmi: sevildi mi nefret mi edildi ikiye bölündü",
    description: "Arthur Fleck'in Lady Gaga'nın canlandırdığı Harley Quinn ile müzikal yolculuğu.",
    posterPath: "/hFB2iFSGJFhQ8bfpMKUQ3m5hGAU.jpg",
    cast: [{ name: "Joaquin Phoenix", character: "Joker", profilePath: null }],
    reviews: [{ source: "IMDB", author: "controversial", quote: "İlkinden farklı ama cesareti takdire şayan. Lady Gaga harika." }],
  },
  {
    title: "Diriliş: Ertuğrul", originalTitle: "Diriliş: Ertuğrul",
